-- ============================================================
-- RPCs à appliquer sur pxjegpicglxobimiqdyl
-- (les ALTER TABLE ont déjà été faits)
-- ============================================================

-- 1/3 : rpc_update_design_metal — ajoute "peek" aux colonnes autorisées
...
-- 2/3 : rpc_update_usinage_titane — ajoute "teinte" aux colonnes autorisées
...
-- 3/3 : rpc_complete_design_metal — copie teintes_associees vers teinte UT
