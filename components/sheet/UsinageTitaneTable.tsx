...
// ── Calendrier (ScrollCalendar partagé) ──────────────────────────
...
export function UsinageTitaneTable({ focusId, onReload, onSelectionChange, onNewCases, onBannerClear }: {
  ...
  async function doToggleHold(caseId: string, reason: string | null) {
    ...
    try {
      const res = await toggleOnHoldAction(caseId, "usinage_titane", reason);
      if (res.ok) {
